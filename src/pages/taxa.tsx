import { Vietnam } from '@/styles/stitches.config'
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Verificação de segurança para saque" />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            ⏰ ATENÇÃO: Este saldo expira em 24 horas caso não faça a verificação!
          </div>

          {/* Action Button */}
          <button 
            onClick={() => window.open('https://checkout.perfectpay.com.br/pay/PPU38COEU3P?upsell=true', '_blank')}
            style={{
            backgroundColor: '#28a745',
            color: 'white',
            border: 'none',
